 var CounterComponent = React.createClass({displayName: "CounterComponent",
     ...
     render : function() {
        return (React.createElement("div", {id: "counterBody"}, React.createElement("h1", null, this.state.count), React.createElement("input", {type: "button", value: label, id: "btn", onClick: this.counter})))
     }
 });
